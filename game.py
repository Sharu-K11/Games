...
def main():
    ...
    PLAYER_IMAGE_STRAIGHT = pygame.image.load("resource/images/characters/boy.png").convert_alpha()
    ...
    PLAYER_IMAGE_RIGHT = pygame.image.load("resource/images/characters/boyright.png").convert_alpha()
    ...
    ROCK_IMAGE = pygame.image.load("resource/images/characters/rock_2.png").convert_alpha()
